...
\hypersetup{
  ...
  pdftitle={Toward a Non-Commutative Residuated Lattice from Quaternion Multiplication},
  pdfauthor={J. Arturo Ornelas Brand},
  pdfsubject={Non-commutative residuated lattices, quaternion algebra},
  pdfkeywords={quaternion, residuated lattice, non-commutative, t-norm, trilemma, lattice order, Hamilton monoid}
}
